...
const factoryData = [
  {
    ...
    tag: "Uttar Pradesh",
    region: "UP",
    address: "Plot No. 62/2/1 & 2, Sahibabad, Site-4, Industrial Area District Ghaziabad, (U.P.) - 201010.",
  ...
  },
  {
    ...
    tag: "Jharkhand",
    region: "JH",
    address: "Plot No. 743, Shed No-1, Jamshedpur, Distt. Saraikela, Jharkhand - 832108",
  ...
  },
  {
    ...
    tag: "Gujarat",
    region: "GJ",
    address: "Plot no. 226 to 229, Gopalcharan Industrial Park, Road no. 7, Bakrol-Bujrang, Daskroi, Ahmedabad – 382433",
  ...
  },
  {
    ...
    tag: "Karnataka",
    region: "KA",
    address: "Building No -5331481412, Road/Street: Kurekuppa Village, 7 Town: Sandur District: Ballari State: Karnataka",
  ...
  },
  {
    ...
    tag: "International",
    region: "BD",
    address: "South Kashimpur, Panchagachia, Feni, Bangladesh",
