      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          >
            ...
            {/* --- New Added Detail: Stats Section --- */}
        ...
        {/* --- New Added Detail: Image Section --- */}
       {/* --- Image Section --- */}
<motion.div 
    variants={fadeInUp}
    initial="hidden"
...
>
    <div className="grid grid-cols-12 gap-4">
        ...
        {/* Orange Block */}
        <div className="col-span-12 md:col-span-5 bg-orange-500 p-8 flex flex-col justify-end h-[200px] md:h-[450px]">
