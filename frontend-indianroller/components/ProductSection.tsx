...
const productData = [
  ...
  },
  {
    ...
    cat: "rubber-rollers",
    desc: "Heavy-duty rubber rollers designed for the cement industry, built to withstand abrasive materials, high loads, and harsh operating conditions.",
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 mb-10 sm:mb-12 md:mb-16">
            <div className="lg:w-1/2">
              <p
                ...
                style={labelInView ? { animation: "slide-left 0.8s ease-out both" } : { opacity: 0 }}
              >
                Catalogue 2026
              </p>
              ...
              <h2
                ...
                style={headingInView ? { animation: "slide-right 0.8s ease-out both" } : { opacity: 0 }}
              >
                OUR PRODUCTS <br />
            ...
            <div className="max-w-xs">
              <p
                ...
                style={descInView ? { animation: "slide-right 0.8s ease-out 0.2s both" } : { opacity: 0 }}
              >
